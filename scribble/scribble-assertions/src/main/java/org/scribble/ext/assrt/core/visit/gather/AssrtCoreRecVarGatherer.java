...
public class AssrtCoreRecVarGatherer<K extends ProtoKind, 
			B extends AssrtCoreSType<K, B>>
		extends AssrtCoreSTypeGatherer<K, B, RecVar>
{
	@Override
	public Stream<RecVar> visitRecVar(AssrtCoreRecVar<K, B> n)
	{
