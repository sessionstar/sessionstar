...
public //abstract class 
		interface AssrtCoreProtocol
		<K extends ProtoKind, N extends ProtoName<K>, B extends Seq<K, B>>
		//extends Protocol<K, N, B>
{
	/*public AssrtCoreProtocol(CommonTree source, List<ProtoMod> mods, N fullname,
			List<Role> rs, List<MemberName<? extends NonRoleParamKind>> ps,
			B def)
	{
		super(source, mods, fullname, rs, ps, null);
	}*/
	...
	public abstract AssrtCoreProtocol<K, N, B> reconstruct(CommonTree source,
	...
	public abstract AssrtCoreProtocol<K, N, B> getInlined(STypeInliner<K, B> v);
	public abstract AssrtCoreProtocol<K, N, B> unfoldAllOnce(STypeUnfolder<K, B> v);
  ...
  // CHECKME: factor out with SType(Base) ?
	...
	public boolean equals(Object o)
	{
		...
		if (!(o instanceof AssrtCoreProtocol))
		{
			return false;
		}
		AssrtCoreProtocol<?, ?, ?> them = (AssrtCoreProtocol<?, ?, ?>) o;
